"""
Django settings for HotelReco project.
...
SECRET_KEY = 'pbs9hz)3$h-9!-##an$&vu^$t+agid^xfcrdfof$ranxwa2^6_'
...
WSGI_APPLICATION = 'HotelReco.wsgi.application'
